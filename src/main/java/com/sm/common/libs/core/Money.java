 ...
 * BigDecimal对象，因此对于大批量统计的性能不够满意。Money类支持 mutable，对大批量统计提供较好的支持。
 * <p>
 * mutable的方法为：{@link #addTo} 、{@link #subtractFrom} 、{@link #multiplyBy} 等。 {@link #divideBy}
 * <li>提供基本的格式化功能。
...
public class Money implements Serializable, Comparable<Money> {
   ...
   */
  protected static final Map<String, Map<String, String>> CURRENCY_DISPLAY_UNIT_MAP = new HashMap<>();
  // 进行初始化工作
  static {
    // 簡體中文的對應錶
    ...
    // 繁體的對應錶
    Map<String, String> zhHKMap = new HashMap<>();
    zhHKMap.put("CNY", "元");
   ...
   * 
   * <p>
   * 如果两货币币种相同，则返回一个新的相同币种的货币对象，其金额为 本货币对象的金额减去参数货币对象的金额。本货币对象的值不变。 如果两货币币种不同，抛出
   * <code>java.lang.IllegalArgumentException</code>。
   * 
   ...
   * 
   * <p>
   * 本货币对象金额乘以乘数，并返回本货币对象。 如果相乘后的金额不能转换为整数分，使用缺省的取整方式 <code>DEFUALT_ROUNDING_MODE</code>进行取整。
   * 
   * @param val 乘数
   * 
   * @return 累乘后的结果。
   ...
   * 
   * <p>
   * 本货币对象金额乘以乘数，并返回本货币对象。 如果相乘后的金额不能转换为整数分，使用指定的取整方式 <code>roundingMode</code>进行取整。
   * 
   * @param val 乘数
   * @param roundingMode 取整方式
   * 
   ...
   * 
   * <p>
   * 本货币对象金额除以除数，并返回本货币对象。 如果相除后的金额不能转换为整数分，使用缺省的取整模式 <code>DEFAULT_ROUNDING_MODE</code>进行取整。
   * 
   * @param val 除数
   * 
   * @return 累除后的结果。
   ...
   * 
   * <p>
   * 本货币对象金额除以除数，并返回本货币对象。 如果相除后的金额不能转换为整数分，使用指定的取整模式 <code>roundingMode</code>进行取整。
   * 
   * @param val 除数
   * @param roundingMode
   * 
  ...
  public String getDisplayUnit() {
    // FIXME
    return getDisplayUnit(LocaleUtils.toLocale(DEFAULT_LOCALE));
  }
  ...
  public String getDisplayUnit(Locale e) {
    if (e == null) {
      e = LocaleUtils.toLocale(DEFAULT_LOCALE);
    }
