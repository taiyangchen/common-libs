 ...
 * @version create on 2016年12月1日 下午3:08:21
 */
public class CompositeLock extends LoggerSupport implements Lock {
  ...
  private static ThreadLocal<QNode> nodeThreadLocal = new ThreadLocal<QNode>() {
    @Override
  ...
  @Override
  public void unlock() {
    QNode acqNode = nodeThreadLocal.get();
