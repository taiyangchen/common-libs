...
import static com.sm.common.libs.util.Assert.assertNotNull;
import static com.sm.common.libs.util.Assert.unexpectedException;
import static com.sm.common.libs.util.Assert.unsupportedOperation;
 ...
 * @version create on 2017年9月6日 下午3:52:33
 */
public final class LocaleInfo implements Cloneable, Externalizable {
  ...
  */
  ...
  public static LocaleInfo parse(String name) {
    name = assertNotNull(StringUtils.trimToNull(name), "no locale name");
