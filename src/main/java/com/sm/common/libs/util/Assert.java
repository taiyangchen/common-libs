...
import com.sm.common.libs.exception.UnexpectedFailureException;
import com.sm.common.libs.exception.UnreachableCodeException;
...
public abstract class Assert {
  ...
  public static <T> T assertNotNull(T object, ExceptionType exceptionType, String message, Object... args) {
    if (object == null) {
      ...
      throw exceptionType
          .newInstance(getMessage(message, args, "[Assertion failed] - the argument is required; it must not be null"));
    }
  ...
  public static <T> T assertNull(T object, ExceptionType exceptionType, String message, Object... args) {
    if (object != null) {
      ...
      throw exceptionType
          .newInstance(getMessage(message, args, "[Assertion failed] - the object argument must be null"));
    }
  ...
  public static void assertTrue(Exception exception, Class<? extends Exception> expectedClass, String expectedMessage) {
    if (exception == null) {
      throw ExceptionType.ILLEGAL_ARGUMENT.newInstance("[Assertion failed] - exception must not be null");
    }
    ...
    if (expectedMessage != null) {
      assertTrue(expectedMessage.equals(exception.getMessage()),
          "[Assertion failed] - expected error message is {}, but {}", expectedMessage, exception.getMessage());
    }
  }
  ...
  public static <T> T unreachableCode(String message, Object... args) {
    throw ExceptionType.UNREACHABLE_CODE
  ...
  public static <T> T unexpectedException(Throwable e, String message, Object... args) {
    RuntimeException exception = ExceptionType.UNEXPECTED_FAILURE
  ...
  public static <T> T fail(String message, Object... args) {
    throw ExceptionType.UNEXPECTED_FAILURE
        .newInstance(getMessage(message, args, "[Assertion failed] - unexpected failure"));
  }
  ...
  public static <T> T unsupportedOperation(String message, Object... args) {
    throw ExceptionType.UNSUPPORTED_OPERATION
        .newInstance(getMessage(message, args, "[Assertion failed] - unsupported operation or unimplemented function"));
  }
